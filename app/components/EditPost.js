    ...
    <Page title="EditPost">
      <form onSubmit={submitHandler}>
        <div className="form-group">
          ...
          {state.title.hasErrors && <div className="alart alert-danger small liveValidateMessage">{state.title.message}</div>}
        </div>
        ...
        <div className="form-group">
          ...
          {state.body.hasErrors && <div className="alart alert-danger small liveValidateMessage">{state.body.message}</div>}
        </div>
