        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input onChange={(e) => setEmail(e.target.value)} htmlFor="email-register" name="email" className="form-control" type="text" placeholder="you@example.com" autoComplete="off" />
            </div>
            <div className="form-group">
